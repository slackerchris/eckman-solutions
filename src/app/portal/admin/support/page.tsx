...
const SUPPORT_PURPOSE_LABELS = ["Support Ticket", "Support ticket", "support ticket", "General Question", "General question", "general question"];
const SUPPORT_PURPOSE_IDS = ["SUPPORT_TICKET", "GENERAL_QUESTION"];
  ...
  const items = await prisma.supportItem.findMany({
    where: {
      ...
      OR: [
        ...
        { purposeId: { in: SUPPORT_PURPOSE_IDS } },
        { purpose: { in: SUPPORT_PURPOSE_LABELS } },
      ],
    },
